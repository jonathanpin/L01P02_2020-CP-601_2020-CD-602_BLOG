...
namespace L01P02_2020_CP_601_2020_CD_602.Controllers
{
    public class publicacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("publicacionId,titulo,descripcion")] publicaciones publicaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("publicacionId,titulo,descripcion")] publicaciones publicaciones)
        {
